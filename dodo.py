...
os.environ['EXAMPLES_HOLOVIZ_AE5_ADMIN_USERNAME'] = 'anaconda-enterprise'
os.environ['EXAMPLES_HOLOVIZ_AE5_ADMIN_PASSWORD'] = 's7cCsU5xaxbdU3C'

# normal user, not admin
os.environ['EXAMPLES_HOLOVIZ_AE5_USERNAME'] = 'holoviz-examples'
os.environ['EXAMPLES_HOLOVIZ_AE5_PASSWORD'] = '%i#1D8aA#DBmPWyI^#$c'
